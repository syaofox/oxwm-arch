...
- Colors at runtime: `~/.Xresources.d/slock` (generated by theme render, loaded by `xrdb -merge` in `.xinitrc`)
  - `slock.init` = `bg` (idle background)
  - `slock.input` = `light_blue` (typing highlight)
  - `slock.fail` = `red` (wrong password)
  - `slock.text` = `text` (message color)
